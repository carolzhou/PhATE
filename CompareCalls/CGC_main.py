...
#    GeneMark, RAST, THEA).  Outputs comparisons accross the gene calls. 
...
INFO_STRING = "This code currently supports the following gene callers:  GeneMark, Glimmer, Prodigal, RAST, and THEA. For more information regarding input to " + CODE_FILE + ", type:  " + CODE_FILE + " input"
